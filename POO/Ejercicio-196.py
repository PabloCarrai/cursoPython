...
class Cliente():
    ...
    def imprimir(self):
        print(f"Cliente {self.nombre} Total {self.monto} ")


class Banco:
    def __init__(self):
        #   Colabora con clase Banco por usar clase Cliente
    ...
    def deposito_totales(self):
        ...
        print(f"El total del dinero del banco es {total}")
